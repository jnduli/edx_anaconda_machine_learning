...
# 
# .. your code here ..
df[['area','perimeter']].plot.scatter(x='area',y='perimeter')
...
# 
# .. your code here ..
df[['groove','asymmetry']].plot.scatter(x='groove',y='asymmetry')
...
# 
# .. your code here ..
df[['compactness','width']].plot.scatter(x='compactness',y='width', marker='^')
