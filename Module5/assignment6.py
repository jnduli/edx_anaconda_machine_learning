...
face = pd.read_csv('Datasets/face_labels.csv',header=None)
label = face.ix[:,0]#.copy
#print face
#
...
#
# .. your code here ..
data_train, data_test, label_train, label_test = train_test_split(df, label, test_size=0.2, random_state=7)
